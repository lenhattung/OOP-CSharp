/*
 ================================================================================
                    DE BAI: QUAN LY SAN PHAM SU DUNG LIST
================================================================================
...
Tao class ProductManager su dung List de quan ly danh sach san pham.
...
7. SAP XEP THEO GIA (1 diem)
   ...
   - Su dung List.Sort() de sap xep theo gia

8. LOC SAN PHAM THEO GIA (1 diem)
   public List FilterByPrice(double minPrice, double maxPrice)
